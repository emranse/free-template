                ...
                <div class="column large-12">
                    ...
                    <ol class="commentlist">
                        ...
                        <li class="thread-alt depth-1 comment">
                            ...
                            <div class="comment__avatar">
                                <img class="avatar" src="/assets/images/avatars/user-04.jpg" alt="" width="50" height="50">
                            </div>
                            ...
                            <ul class="children">
                                ...
                                <li class="depth-2 comment">
                                    ...
                                    <div class="comment__avatar">
                                        <img class="avatar" src="/assets/images/avatars/user-03.jpg" alt="" width="50" height="50">
                                    </div>
                        ...
                        <li class="depth-1 comment">
                            ...
                            <div class="comment__avatar">
                                <img class="avatar" src="/assets/images/avatars/user-02.jpg" alt="" width="50" height="50">
                            </div>
